...
//    CurrentArchiveList.push_back(StartupDir + "Pak0.pk3");
//    CurrentArchiveList.push_back(StartupDir + "Pak1.pk3");
//    CurrentArchiveList.push_back(StartupDir + "Pak2.pk3");
//    CurrentArchiveList.push_back(StartupDir + "Pak5.pk3");
...
void CQuake3EventHandler::LoadMap ( const stringw &mapName, s32 collision )
{
	...
	file->drop ();
	            ...
	            Game->Device->getFileSystem()->addFileArchive("./Pak0.pk3");
             Game->Device->getFileSystem()->addFileArchive("./Pak1.pk3");
            Game->Device->getFileSystem()->addFileArchive("./Pak2.pk3");
//  Game->Device->getFileSystem()->addFileArchive("./pak5.pk3");
	...
	// load the actual map
	  ...
	  CMOHAALevelMesh cmesh(fs,smgr,Game->loadParam); //createMesh
	    cmesh.loadFile(fs->createAndOpenFile("mohdm6.bsp"));
//Mesh =  (IQ3LevelMesh*) cmesh.getMesh(0,0,0,1);
//Mesh =  (IQ3LevelMesh*) smgr->addOctreeSceneNode(cmesh.getMesh(0,0,0,1));
	...
	*/
	...
	IMesh *geometry = cmesh.getMesh(0,0,0,1);
...
//	MapParent = smgr->addOctreeSceneNode(geometry, 0, -1, minimalNodes);
	MapParent = smgr->addOctreeSceneNode(cmesh.getMesh(0,0,0,1));
